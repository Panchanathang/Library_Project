<%@ Page Title="Adminsitrator DashBoard" Language="C#" MasterPageFile="~/Admin/AdminSite.Master" AutoEventWireup="true" CodeBehind="AdminHome.aspx.cs" Inherits="Library_Project.Admin.AdminHome" %>
        ...
        <div class="col-lg-4 mb-4">
            ...
            <div class="card h-100 border-start-lg border-start-success">
                <div class="card-body">
                    ...
                    <div class="h3 d-flex align-items-center"> $ <asp:Label ID="lblamount" runat="server" Text="Label"></asp:Label></div>
                    <a class="text-arrow-icon small text-success" href="Penalty.aspx">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg>
                    </a>
                </div>
            </div>
