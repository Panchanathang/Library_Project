...
namespace Library_Project.Admin
{
    public partial class UpdateMemberDetails : System.Web.UI.Page
    {
        ...
        private void Search_memberRecord()
        {
            ...
            if (dr.HasRows)
            {
                while (dr.Read())
                {
                    ...
                    ddlprovince.SelectedValue = dr.GetValue(6).ToString();
                    txtPostalcode.Text = dr.GetValue(7).ToString();
                }
            }
            else
            {
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            DropDownList updateddlprovince = (DropDownList)GridView1.Rows[e.RowIndex].FindControl("ddlEditProvince");
            TextBox updatetxtpostalcode = (TextBox)GridView1.Rows[e.RowIndex].FindControl("txtEditpostalcode");
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                DropDownList ddlEditProvince_value = (DropDownList)e.Row.FindControl("ddlEditProvince");
                Label lblprovince = (Label)e.Row.FindControl("lblEditProvince");
                ddlEditProvince_value.SelectedValue = lblprovince.Text;
