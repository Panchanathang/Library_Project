...
namespace Library_Project.Admin
{
    public partial class AdminHome : System.Web.UI.Page
    {
        ...
        {
            cmd = new SqlCommand("select sum(penaltyamount)as tot from BookPenaltyRecord", dbcon.GetCon());
        ...
        {
            cmd = new SqlCommand("select count(*)as Issuebook from book_issue_tbl", dbcon.GetCon());
            cmd.CommandType = System.Data.CommandType.Text;
            cmd.Parameters.Clear();
